...
void TimerWindow::updateClock() {
    ...
    trayIcon->setToolTip( QString::number(minutesRemaining) + " " + tr("Minutes Left") );
...
void TimerWindow::restoreTimerWindow(){
    ...
    //TODO: TimerWindow will not come to front if behind other windows. Needed for showMessage().
